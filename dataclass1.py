...
class Config:
    ...
    def __post_init__(self):
        ...
        self.file_path = self.base_path / f"{self.model_segment}_{self.yyyymm}{self.extension}"
    ...
    def generate_file_name(self, file_type):
        ...
        return self.base_path / f"{self.model_segment}_{self.yyyymm}_{file_type}{self.extension}"

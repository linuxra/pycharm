    ...
    def save(self, file_name: str):
        ...
        with PdfPages(file_name) as pdf_pages:
            for page in range(num_pages):
                ...
                table_data = self.df.iloc[start:end]
                table = render_mpl_table(table_data, ax=ax_table, header_columns=0, col_width=2.0)
...
# Generate and save the plots to the same PDF file
#table.save('my_table_and_plots.pdf')